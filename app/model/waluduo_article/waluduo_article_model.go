...
// arModel is a active record design model for table waluduo_article operations.
type arModel struct {
	M *gdb.Model
}

var (
	// Table is the table name of waluduo_article.
	Table = "waluduo_article"
	// Model is the model object of waluduo_article.
